	...
	public static function all() {
		$bots = array(
			...
			'oai-searchbot'    => array(
				...
				'note'   => __( 'Builds the index behind ChatGPT search. Answers link back to you.', 'aumcrawl' ),
			...
			'chatgpt-user'     => array(
				...
				'robots' => 'ChatGPT-User',
				'note'   => __( 'Fetches a page because someone in ChatGPT clicked through to it.', 'aumcrawl' ),
				'verify' => array( 'openai.com' ),
			),
			'perplexitybot'    => array(
				'label'  => 'PerplexityBot',
				...
				'note'   => __( 'Indexes for Perplexity, which shows sources under every answer.', 'aumcrawl' ),
			...
			'perplexity-user'  => array(
				...
				'note'   => __( 'A person following a citation out of a Perplexity answer.', 'aumcrawl' ),
				'verify' => array( 'perplexity.ai', 'perplexity.com' ),
			),
			'claude-user'      => array(
				'label'  => 'Claude-User',
				...
				'robots' => 'Claude-User',
				'note'   => __( 'Fetches a page on behalf of someone chatting with Claude.', 'aumcrawl' ),
			...
			'claude-searchbot' => array(
				...
				'note'   => __( 'Builds the search index Claude cites from.', 'aumcrawl' ),
				'verify' => array( 'anthropic.com' ),
			),
			'google-extended'  => array(
				...
				'note'   => __( 'A robots.txt token, not a crawler. Controls whether Gemini and AI Overviews may ground answers in your content. Blocking it does not affect normal Google Search ranking.', 'aumcrawl' ),
				'verify' => array(),
			),
			...
			'gptbot'           => array(
				...
				'ua'     => array( 'GPTBot' ),
				'robots' => 'GPTBot',
				'note'   => __( 'Collects content to train OpenAI models. Separate from ChatGPT search.', 'aumcrawl' ),
				'verify' => array( 'openai.com' ),
			),
			'claudebot'        => array(
				'label'  => 'ClaudeBot',
				...
				'robots' => 'ClaudeBot',
				'note'   => __( 'Collects content to train Anthropic models.', 'aumcrawl' ),
				'verify' => array( 'anthropic.com' ),
			),
			'ccbot'            => array(
				'label'  => 'CCBot',
				...
				'ua'     => array( 'CCBot' ),
				'robots' => 'CCBot',
				'note'   => __( 'Builds the public Common Crawl archive, which nearly every model vendor trains on.', 'aumcrawl' ),
				'verify' => array(),
			),
			'bytespider'       => array(
				'label'  => 'Bytespider',
				...
				'ua'     => array( 'Bytespider' ),
				'robots' => 'Bytespider',
				'note'   => __( 'ByteDance training crawler. Widely reported as heavy-handed about crawl rate.', 'aumcrawl' ),
				'verify' => array(),
			),
			'applebot-extended' => array(
				...
				'note'   => __( 'A robots.txt token that opts your content out of Apple model training. Does not affect Siri or Spotlight.', 'aumcrawl' ),
				'verify' => array(),
			),
			'meta-externalagent' => array(
				...
				'note'   => __( 'Collects content for Meta AI training.', 'aumcrawl' ),
				'verify' => array(),
			),
			'amazonbot'        => array(
				'label'  => 'Amazonbot',
				...
				'ua'     => array( 'Amazonbot' ),
				'robots' => 'Amazonbot',
				'note'   => __( 'Feeds Amazon services including model training.', 'aumcrawl' ),
				'verify' => array(),
			),
			'diffbot'          => array(
				'label'  => 'Diffbot',
				...
				'ua'     => array( 'Diffbot' ),
				'robots' => 'Diffbot',
				'note'   => __( 'Extracts structured data and resells it as a commercial dataset.', 'aumcrawl' ),
				'verify' => array(),
			),
			'omgilibot'        => array(
				'label'  => 'omgilibot',
				...
				'robots' => 'omgilibot',
				'note'   => __( 'Collects web data sold on as a training corpus.', 'aumcrawl' ),
				'verify' => array(),
			),
			'ahrefsbot'        => array(
				'label'  => 'AhrefsBot',
				...
				'ua'     => array( 'AhrefsBot' ),
				'robots' => 'AhrefsBot',
				'note'   => __( 'Maps your backlinks so Ahrefs subscribers, including competitors, can study them.', 'aumcrawl' ),
			...
			'semrushbot'       => array(
				...
				'ua'     => array( 'SemrushBot' ),
				'robots' => 'SemrushBot',
				'note'   => __( 'Same idea as AhrefsBot, for the Semrush index.', 'aumcrawl' ),
			...
			'mj12bot'          => array(
				...
				'ua'     => array( 'MJ12bot' ),
				'robots' => 'MJ12bot',
				'note'   => __( 'Majestic backlink crawler.', 'aumcrawl' ),
				'verify' => array(),
			),
			'dotbot'           => array(
				'label'  => 'DotBot',
				...
				'ua'     => array( 'DotBot' ),
				'robots' => 'DotBot',
				'note'   => __( 'Moz backlink crawler.', 'aumcrawl' ),
				'verify' => array(),
			),
			'dataforseobot'    => array(
				'label'  => 'DataForSeoBot',
				...
				'note'   => __( 'Collects SERP and site data sold through an API.', 'aumcrawl' ),
				'verify' => array(),
			),
			...
			'googlebot'        => array(
				...
				'ua'     => array( 'Googlebot' ),
				'robots' => 'Googlebot',
				'note'   => __( 'Google Search. Blocking it removes you from Google.', 'aumcrawl' ),
			...
			'bingbot'          => array(
				...
				'ua'     => array( 'bingbot' ),
				'robots' => 'bingbot',
				'note'   => __( 'Bing Search, which also grounds Microsoft Copilot.', 'aumcrawl' ),
			...
			'baiduspider'      => array(
				...
				'robots' => 'Baiduspider',
				'note'   => __( 'Baidu Search. Blocking it removes you from search in mainland China.', 'aumcrawl' ),
			...
			'yandexbot'        => array(
				...
				'ua'     => array( 'YandexBot' ),
				'robots' => 'Yandex',
				'note'   => __( 'Yandex Search — Russia, and much of the Russian-speaking web.', 'aumcrawl' ),
			...
			'sogou'            => array(
				...
				'note'   => __( 'Sogou Search, mainland China.', 'aumcrawl' ),
				'verify' => array(),
			),
			'360spider'        => array(
				'label'  => '360Spider',
				...
				'robots' => '360Spider',
				'note'   => __( 'Qihoo 360 / Haosou Search, mainland China.', 'aumcrawl' ),
				'verify' => array(),
			),
			'yisouspider'      => array(
				'label'  => 'YisouSpider',
				...
				'robots' => 'YisouSpider',
				'note'   => __( 'Shenma Search — the default on UC Browser, and mostly mobile.', 'aumcrawl' ),
				'verify' => array(),
			),
			'petalbot'         => array(
				'label'  => 'PetalBot',
				...
				'ua'     => array( 'PetalBot' ),
				'robots' => 'PetalBot',
				'note'   => __( 'Petal Search, the search built into Huawei devices.', 'aumcrawl' ),
				'verify' => array(),
			),
			'yeti'             => array(
				'label'  => 'Yeti',
				...
				'ua'     => array( 'Yeti' ),
				'robots' => 'Yeti',
				'note'   => __( 'Naver Search, South Korea.', 'aumcrawl' ),
				'verify' => array(),
			),
			'duckduckbot'      => array(
				'label'  => 'DuckDuckBot',
				...
				'robots' => 'DuckDuckBot',
				'note'   => __( 'DuckDuckGo Search.', 'aumcrawl' ),
				'verify' => array(),
			),
			'applebot'         => array(
				'label'  => 'Applebot',
				...
				'ua'     => array( 'Applebot' ),
				'robots' => 'Applebot',
				'note'   => __( 'Siri and Spotlight suggestions. Separate from Applebot-Extended.', 'aumcrawl' ),
			...
			'facebookexternalhit' => array(
				...
				'note'   => __( 'Builds the preview card when someone shares your link. Blocking it means shares appear without a title or image.', 'aumcrawl' ),
				'verify' => array(),
			),
			'twitterbot'       => array(
				'label'  => 'Twitterbot',
				...
				'ua'     => array( 'Twitterbot' ),
				'robots' => 'Twitterbot',
				'note'   => __( 'Link preview cards on X.', 'aumcrawl' ),
				'verify' => array(),
			),
			'linkedinbot'      => array(
				'label'  => 'LinkedInBot',
				...
				'robots' => 'LinkedInBot',
				'note'   => __( 'Link preview cards on LinkedIn.', 'aumcrawl' ),
				'verify' => array(),
			),
		);
		 ...
		 */
		return apply_filters( 'aumcrawl_bots', $bots );
	}
